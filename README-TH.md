...
## 🛠️ คู่มือเริ่มใช้งานฉบับรวบรัด (Quick Start Setup)
...
## 🎨 การปรับแต่งนิสัยและบุคลิกของ AI (Persona Customization)

คุณไม่จำเป็นต้องใช้โค้ดตัวนี้เป็นบอทวิชาการ/นักโภชนาการที่ตึงเครียดเสมอไป คุณสามารถเนรมิตให้ AI ของคุณกลายเป็นเทรนเนอร์จอมด่า, ป้าแม่ค้าปากซอย, หรือหุ่นยนต์แสกนเป๊ะๆ ก็ได้ แค่ทำตามนี้:

1. เปิดไฟล์ `app/gemini.py`
2. เลื่อนหาตัวแปรที่ชื่อ `system_prompt`
3. ลบข้อความในเครื่องหมายอัญประกาศ (`"""`) ออกให้หมด แล้วป้อนคำสั่งหรือกติกาใหม่ที่คุณต้องการใส่ลงไป

**🔥 ตัวอย่างการแก้ System Prompt (เปลี่ยนเป็นเทรนเนอร์จอมดุ):**
```python
system_prompt = """
สวมบทบาทเป็น "เทรนเนอร์ฟิตเนสสุดโหดและปากแจ๋ว" 
หน้าที่ของคุณคือจับผิดการกินของผู้ใช้งาน 
