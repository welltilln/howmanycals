...
**Google Gemini 2.5 FlashAILINE** <br>
...
## **How Many Cals** LINEGoogleGemini Vision**SQLite**AI---

## * **** * **DB** SQLite* **** * **** AI* **** `run.sh` / `run.bat` Ngrok---
...
## ### 1. **[LINE Messaging API](https://developers.line.biz/console/):** `Channel Secret` `Channel Access Token`2. **[Google Gemini API Key](https://aistudio.google.com/):** Google AI Studio API3. **[Ngrok Auth Token](https://dashboard.ngrok.com/):** LINE### 1: ```bash
...
### 3: LINENgrok URL: `https://xxxx.ngrok.app/callback`LINE Developers Console**Webhook URL** Verify ---

## (Docker)

VPS24365Docker1. [Docker](https://docs.docker.com/get-docker/) [Docker Compose](https://docs.docker.com/compose/) 2. ```bash
